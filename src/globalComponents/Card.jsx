...
function Card() {
    return (
        <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 layout-spacing">
            <div className="widget widget-three">
                <div className="widget-heading">
                    <h5 className>Summary</h5>
                    <div className="task-action">
                        <div className="dropdown">
                            <a className="dropdown-toggle" href="xxx" role="button" id="pendingTask" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="pendingTask" style={{ willChange: 'transform' }}>
                                <a className="dropdown-item" href="xxx">View Report</a>
                                <a className="dropdown-item" href="xxx">Edit Report</a>
                                <a className="dropdown-item" href="xxx">Mark as Done</a>
                            </div>
                        </div>
                    </div>
                </div>
